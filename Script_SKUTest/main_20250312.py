...
def main():
    ...
    checkbox1.pack(fill=tk.X, padx=5, pady=1)
    ...
    checkbox2.pack(fill=tk.X, padx=5, pady=1)
    ...
    checkbox3.pack(fill=tk.X, padx=5, pady=1)
    ...
    checkbox4.pack(fill=tk.X, padx=5, pady=1)
    ...
    checkbox5.pack(fill=tk.X, padx=5, pady=1)
    ...
    checkbox6.pack(fill=tk.X, padx=5, pady=1)
    # 收件人列表框架
